...
export interface IWebViewPoseMessageCatData {
  channel: string;
  correlationId: string;
  request: Request;
}
export interface IWebViewOnMessageCatData {
  channel: string;
  correlationId: string;
  response: Response;
}
export type WebViewCatOnDataEvent = CustomEvent<IWebViewOnMessageCatData>;
